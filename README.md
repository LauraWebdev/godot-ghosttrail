...
## Download
Download the latest release [from GitHub](https://github.com/LauraWebdev/godot-ghosttrail/releases), the [Godot AssetLib](https://godotengine.org/asset-library/asset/4920) or the [Godot Asset Store](https://store-beta.godotengine.org/asset/indiegesindel/ghosttrail/).
